...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imagex
```

A live public deployment of this template is available at [https://imagex.templates.workers.dev](https://imagex.templates.workers.dev)
